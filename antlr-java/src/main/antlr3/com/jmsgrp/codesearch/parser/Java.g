...
@lexer::header {
package com.jmsgrp.codesearch.parser;
}
...
packageDeclaration
	:	'package'{System.out.print("package ");} qualifiedName ';'{System.out.println(";");}
	;
...
qualifiedName
	:	t=Identifier{System.out.print($t.text);} ('.'{System.out.print(".");} t=Identifier{System.out.print($t.text);})*
	;
